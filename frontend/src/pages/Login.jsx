...
import { Loader, AlertCircle, Eye, EyeOff, ChevronLeft, Recycle, User, Lock } from 'lucide-react';
      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col p-8 sm:p-12 xl:p-24 relative overflow-y-auto">
        ...
        >
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3 tracking-tight">Welcome Back</h1>
            <p className="text-gray-500 dark:text-gray-400 text-sm">Sign in to continue to Smart Waste AI</p>
          </div>
          ...
          <div className="bg-white dark:bg-[#0a1321]/80 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-[2rem] p-8 sm:p-10 shadow-xl">
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2 group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl pl-11 pr-4 py-3.5 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-600 focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/50 transition-all"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2 group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl pl-11 pr-12 py-3.5 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-600 focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/50 transition-all"
                    required
                  />
                  <button 
                    type="button" 
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 rounded border-gray-300 text-green-600 focus:ring-green-500 bg-white dark:bg-black/20 dark:border-white/20 dark:checked:bg-green-500 cursor-pointer"
                  />
                  <label htmlFor="remember-me" className="ml-2 block text-sm font-medium text-gray-700 dark:text-gray-300 cursor-pointer select-none">
                    Remember me
                  </label>
                </div>
                <Link
                  to="/forgot-password"
                  className="text-sm font-medium text-green-600 dark:text-green-400 hover:text-green-500 hover:underline transition-colors"
                >
                  Forgot Password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-green-500 to-emerald-400 hover:from-green-400 hover:to-emerald-300 text-black font-bold py-4 rounded-xl transition-all transform hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(34,197,94,0.4)] flex justify-center items-center gap-2"
              >
                {loading ? <Loader size={20} className="animate-spin" /> : "Sign In to Workspace"}
              </button>
            </form>
          </div>

          <div className="mt-8 text-center text-gray-500 dark:text-gray-400 text-sm">
            Don't have an account? <Link to="/register" className="text-green-600 dark:text-green-400 font-semibold hover:underline ml-1">Create one</Link>
          </div>
        </motion.div>
      </div>
